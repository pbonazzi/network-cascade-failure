...
print("\n++++++++++++++++++++++++++++++")
print("SF N2000 gamma 2.3 Graph Generte...")
print("++++++++++++++++++++++++++++++\n")

start = datetime.now()
SFn2000_23_a = networkSF_w_3Dpos_PowerL(2000,2.3,1)
nx.write_gpickle(SFn2000_23_a, "../data/pickle/SF/SFn2000_23_a.gpickle")
time = datetime.now() - start
print("...SFn2000_23_a Graph Generate Done!", time)

start = datetime.now()
SFn2000_23_b = networkSF_w_3Dpos_PowerL(2000,2.3,2)
nx.write_gpickle(SFn2000_23_b, "../data/pickle/SF/SFn2000_23_b.gpickle")
time = datetime.now() - start
print("...SFn2000_23_b Graph Generate Done!", time)

start = datetime.now()
int_SFn2000_23 = intd_random_net(SFn2000_23_a,SFn2000_23_b)
nx.write_gpickle(int_SFn2000_23, "../data/pickle/SF/int_SFn2000_23.gpickle")
time = datetime.now() - start
print("...int_SFn2000_23 Graph Generate Done!", time)
